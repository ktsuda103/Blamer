                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('mypage/update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="name" type="text" class="@error('name') is-invalid @enderror input" name="name" value="{{ $user->name }}" autocomplete="name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="email" type="email" class="@error('email') is-invalid @enderror input" name="email" value="{{ $user->email }}" autocomplete="email">
